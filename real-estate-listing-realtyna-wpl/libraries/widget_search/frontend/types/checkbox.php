...
function widget_search_frontend_general_checkbox(
    ...
    if (in_array($type, array('checkbox', 'yesno', 'select', 'tag', 'boolean'))) {
        switch ($field['type']) {
            case 'checkbox':
                $show = 'checkbox';
                break;
...
add_filter('widget_search/frontend/general/boolean', 'widget_search_frontend_general_checkbox', 10, 8);
